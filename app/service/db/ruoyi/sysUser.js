...
class SysUserService extends Service {
    mapper(sqlid, values, params) {
        return this.app.mapper('mapper/ruoyi/sysUser.xml', sqlid, values, params)
    }
    ...
    selectUserByOpenIdMapper(values, params) {
        return this.mapper('selectUserByOpenId', values, params);
    }

    async selectUserByOpenId(values, params) {
        return await this.db().select(this.selectUserByOpenIdMapper(values, params));
    }
